 ...
 ***********************************************************************
 *   @file cos_ser.c
 *   @par Module:    renesas controller serielle Kommunikation
 *
 *   @brief  Diese Datei enthaelt Routinen fuer die serielle Schnittstelle
 *           der renesas Controller. Es wird das bsp (Zink) genutzt. Die
 *           Routinen nutzen putchar() und getchar()
 *
 *
 ...
 *   @par History       :
 *   @verbatim
 * Ver  Date        Author            Beschreibung
 * 0.0  04.12.2008  E. Forgber        Datei erzeugt
 * 0.1  20.03.2013  E. Forgber        Dokumentation auf Deutsch umgestellt
 * 0.2  09.10.2015  E. Forgber (Fgb)  Umstieg auf renesas controller
 *
 *   @endverbatim
 *
 *
...
Dieses Modul enthaelt Routinen fuer die serielle Kommunikation auf renesas
Controllern.
 **********************************************************************/
/**************************************************************************
